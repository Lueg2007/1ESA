...
angulo2 = int(input("Qual é o segundo grau do seu triângulo?:"))
angulo3 = int(input("Qual é o terceiro grau do seu triângulo?:"))
if angulo + angulo2 + angulo3 == 180:
    if angulo == 90 or angulo2 == 90 or angulo3 == 90:
        print("Seu triângulo é retângulo")
    elif angulo > 90 and angulo <180 or angulo2 > 90 and angulo2 <180 or angulo3 > 90 and angulo3 <180:
        print("Seu triângulo é obtusângulo")
    elif angulo < 90 and angulo > 0 and angulo2 < 90 and angulo2 > 0 and angulo3 < 90 and angulo3 > 0:
